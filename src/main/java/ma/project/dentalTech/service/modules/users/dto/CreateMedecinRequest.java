...
public class CreateMedecinRequest {
    ...
    public CreateMedecinRequest(String nom, String prenom, String email, String specialite) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
    ...
    public String getAgendaMensuel() {
        return agendaMensuel;
    }

    public void setAgendaMensuel(String agendaMensuel) {
